...
class Ezvizswitch(SwitchEntity, RestoreEntity):
    ...
    def turn_on(self, **kwargs) -> None:
        ...
        # 使用pyezvizapi库的方法控制设备
        if self._ezviz_client.switch_device(self._switch["deviceSerial"], DeviceSwitchType.PLUG, True):
            self._state = True
    ...
    def turn_off(self, **kwargs) -> None:
        ...
        # 使用pyezvizapi库的方法控制设备
        if self._ezviz_client.switch_device(self._switch["deviceSerial"], DeviceSwitchType.PLUG, False):
            self._state = False
